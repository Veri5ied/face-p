  ...
  return (
    <>
      ...
      <div className="border border-gray-100 bg-white rounded-md shadow-md py-4 mb-4">
          ...
          <li className="flex flex-row gap-1 items-center">
            ...
            <div className="flex flex-col">
              ...
              <small className="text-gray-800">
                {getPostByAuthorInfo().a_name}
              </small>
              <small className="text-gray-500">
                <span>{timePosted && formatTimestamp(timePosted)}</span>
        ...
        <div className="flex flex-row justify-between px-4">
          <div className="flex items-center justify-center w-[20px] h-[20px] rounded-full bg-sky-800">
            <ThumbUpIcon sx={{ color: "white", fontSize: 15 }} />
          </div>
      ...
      >
        ...
        <Button variant="outlined" color="error" onClick={handleDeletePostt}>
          Yes, Delete
        </Button>
      </CustomDialog>
