...
export default function Signin() {
  ...
  /*  const handleGoogleEmailPasswordSignIn = async (userEmail, userPassword) => {
  ...
  const handleFirebaseSignIn = async (userEmail, userPassword) => {
    try {
  ...
  const { handleBlur, handleSubmit, handleChange, errors, touched, values } =
    useFormik({
      ...
      onSubmit: async (values) => {
        handleFirebaseSignIn(values.email, values.password);
        console.log(values);
      },
