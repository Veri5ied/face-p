...
export default function PartnerSignup() {
    ...
    const [showActivityIndicator, setShowActivityIndicator] = useState(null);
...
//         const imageRef = ref(storage, `partners/${docRes.id}`)
...
//     const { handleBlur, handleSubmit, handleChange, errors, touched, values } = useFormik({
//         initialValues: { email: '', compName: '', compDes: '', phone: '' },
//         onSubmit: values => {
//             //create user account
//             console.log(values)
...
//         <>
//             <Head>
//                 <link rel="icon" href="/imgs/facepal_icon_logo.ico" />
//                 <meta name="description" content="The coolest" />
//                 <meta name="keywords" content="facepal" />
//                 <title>facepal | Become a partner</title>
//             </Head>
//             <div className="h-screen w-full flex  justify-center mobile-bg sm:tablet-bg lg:desktop-bg">
//                 <div className="bg-gray-800/40 w-full sm:w-[520px] flex flex-col justify-center items-center gap-4 ">
//                     <h1 className="text-white text-4xl text-center">Partner Account Application</h1>
...
//                             onBlur={handleBlur}
//                             placeholder="Company Name"
//                             className="py-3 sm:py-5 px-1 border border-indigo-400 rounded-lg bg-white/60"
//                         />
//                         {errors.compName && touched.compName ? (<span className=" text-red-500">{errors.compName}</span>) : null}
...
//                         <button type="submit" className="max-w-[160px] h-12 bg-indigo-800 rounded-lg text-white font-bold"
//                         ><Link> Submit Application</Link></button>
