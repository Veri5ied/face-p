          ...
          <header className="bg-indigo-300 p-3 ">
            ...
            <div>
              <p className="text-sm mt-1">
                ...
                eum voluptatum distinctio rem culpa aperiam assumenda deserunt
                molestias, doloremque iusto adipisicing elit. Reprehenderit est
                vitae alias officiis!
              </p>

              <GoSignOut className="text-gray-800 my-3" onClick={signOut} />
...
//         );
//         const onSnapShot = await getDocs(q);
//         setuserPost(onSnapShot.docs.map(doc => {
//             return {
//                 id: doc.id,
//                 data: {
//                     ...doc.data()
